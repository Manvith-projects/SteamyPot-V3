...
function OrderPlaced() {
  ...
  return (
    <div className='min-h-screen flex flex-col justify-center items-center px-4 text-center relative overflow-hidden' style={{background: 'var(--bg)', backgroundImage: 'radial-gradient(circle at 20% 30%, var(--accent-soft) 0%, transparent 60%), radial-gradient(circle at 80% 70%, var(--accent-soft) 0%, transparent 60%)'}}>
